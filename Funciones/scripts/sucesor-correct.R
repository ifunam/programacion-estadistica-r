# ¡Estás a punto de escribir tu primera función!
# Las funciones son definidas de la siguiente manera:
#
#  nombre_de_funcion <- function(argumento_1, argumento_2){
...
#
# A continuación crearás una función llamada sucesor. Esta función toma un
# argumento 'x' y regresa el sucesor de x (x + 1). Borra el símbolo # enfrente
# de la x para hacer que la función funcione. Cerciórate de guardar tus cambios
